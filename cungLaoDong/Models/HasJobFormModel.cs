...
public class HasJobFormModel
{
    ...
    [Column("ncvl_vi_the_viec_lam")] public int? JobPositionId { get; set; }
    [Column("cong_viec_id")] public int? JobId { get; set; }
    [Column("ncvl_dia_chi_tinh")] public int? AddressProvince { get; set; }
    [Column("ncvl_dia_chi_xa")] public int? AddressWeird { get; set; }
